  ...
  return (
    <div className='box-about'>
      ...
      <div className='box-about-txt'>
        <h1>{nome}</h1>
        <div>
          <p>DESDE 2017 ATUANDO  COMO FOTÓGRAFO PROFISSIONAL E POSSO DIZER QUE A FOTOGRAFIA É MINHA PAIXÃO E COM ELA CONTO HISTÓRIAS ÚNICAS E EMOCIONANTES. TENHO O PRIVILÉGIO DE CAPTURAR OS MOMENTOS MAIS ESPECIAIS E IMPORTANTES NA VIDA DAS PESSOAS.</p>
